...
| Azure AI/ML | `azure-ai-ml.yml` | 50+ | OpenAI Service, Cognitive Services, ML Studio, Bot Service |
...
| Azure Identity | `azure-identity.yml` | 35+ | Entra ID, B2C, Managed Identity, Conditional Access |
...
3. **Only if you need repo-level detail** (names, URLs, classifications): load the full YAML file
4. For most fact-checking, the category name is sufficient to scope your `microsoft_docs_search` queries
